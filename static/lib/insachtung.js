...
(function() {
  var Bitmap, Bonus, Controller, CrashController, NoWall, Painter, Player, PlayerInstance, Round, addPlayerButton, canvas, controller, playerSelectionForm, playersConfiguration,
  ...
  window.setLeftKey = function(button, playerIndex) {
    ...
    return document.onkeydown = function(e) {
      ...
      return button.value = String.fromCharCode(e.keyCode);
    };
  };
